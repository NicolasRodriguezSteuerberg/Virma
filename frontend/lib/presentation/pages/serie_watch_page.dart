      ...
      body: Listener(
        ...
        child: Stack(
          ...
          children: [
            ...
            if (vm.showControls) Positioned(top: 0, left: 0, child: BackControls(route: "/serie/${vm.info!.serieId}"),),
          ],
        ),
      )
    );
...
class SerieWatchPage extends StatefulWidget {
  final String episodeId;

  const SerieWatchPage({required this.episodeId, super.key});

  @override
  State<SerieWatchPage> createState() => _SerieWatchPageState();
}

class _SerieWatchPageState extends State<SerieWatchPage> {
  @override
  void initState() {
    super.initState();
